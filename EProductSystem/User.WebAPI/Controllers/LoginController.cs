...
namespace User.WebAPI.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public async Task<ActionResult <ServiceResponse<string>>> LoginByPhoneAndPassword(LoginRequest req)
        {
            ...
            var result = await _userDomainService.CheckPassword(req.phone, req.password);
            switch (result)
            {
        ...
        public async Task<ActionResult <ServiceResponse<string >>>LoginByPhoneAndCode(LoginRequest req)
        {
            ...
            var result = await _userDomainService.CheckPhoneNumberCodeAsync(req.phone, req.code);
        ...
        public async Task <ActionResult<ServiceResponse<bool>>> GetCode(LoginRequest req)
        {
            ...
            await _userDomainService.SendCodeAsync(req.phone, randomNumber.ToSafeString());
            resp.Data = true;
            resp.Message = "发送成功";
            return Ok(resp);
        }
